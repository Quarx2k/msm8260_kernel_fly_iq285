...
#define KTTECH_CAMERA_MSG(fmt, args...) printk(KERN_INFO "msm_io_8x60: " fmt, ##args)  // jykim
//#undef CDBG
//#define CDBG(fmt, args...) printk(KERN_INFO "msm_io_8x60: " fmt, ##args)  // jykim
...
static irqreturn_t msm_io_csi_irq(int irq_num, void *data)
{
	...
	KTTECH_CAMERA_MSG("%s MIPI_INTERRUPT_STATUS = 0x%x\n", __func__, irq);
#else
...
#if defined(CONFIG_KTTECH_MT9M113) || defined(CONFIG_KTTECH_MT9E013)
	KTTECH_CAMERA_MSG("%s: camio_ext.csi=0x%08x, camio_ext.csisz=0x%08x\n", __func__,  (int) camio_ext.csiphy, (int) camio_ext.csisz);
	KTTECH_CAMERA_MSG("%s: csibase=%08x\n", __func__, (int) csibase);
#endif
