...
#define   PM_KPD_PWRON_EVENT_IRQ_HDL_8058 (32)
#define	PM_KPD_PWR_KEY_OFF_IRQ_HDL_8058 (50)
#define	PM_KPD_PWR_KEY_ON_IRQ_HDL_8058 (51)


int pm8058_irq_get_pwrkey_status(struct pm8058_chip *chip, int irq)
{
	int     rc;
	u8      block, bits, bit;
...
int pm8058_is_pwr_key_pressed(void)
{
   int dummy1, dummy2, ret = 0;
	// Dummy Read For Clear IRQs
   dummy1 = pm8058_irq_get_pwrkey_status(NULL,PM_KPD_PWR_KEY_OFF_IRQ_HDL_8058);
   dummy2 = pm8058_irq_get_pwrkey_status(NULL,PM_KPD_PWRON_EVENT_IRQ_HDL_8058);
   // Prevent Debounce
   ret = pm8058_irq_get_pwrkey_status(NULL,PM_KPD_PWR_KEY_ON_IRQ_HDL_8058);
   // Read Pwr Key Press
   ret = pm8058_irq_get_pwrkey_status(NULL,PM_KPD_PWR_KEY_ON_IRQ_HDL_8058);
  printk("pm8058_is_pwr_key_pressed ret=> %d\n", ret);
   return ret;
}
#endif
