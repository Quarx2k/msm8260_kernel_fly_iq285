...
static struct gpiomux_setting console_uart_dn = {
	.func = GPIOMUX_FUNC_2,
	.drv = GPIOMUX_DRV_2MA,
...
static struct gpiomux_setting default_sleep_pu = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
...
#if defined(CONFIG_KTTECH_MT9E013) || defined(CONFIG_KTTECH_MT9M113) // jykim 110311
...
#ifdef CONFIG_MACH_KTTECH 
static struct gpiomux_setting gsbi_i2c_touch = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_4MA,
	.pull = GPIOMUX_PULL_UP,
};

static struct gpiomux_setting gsbi_irq_sleep = {
...
static struct msm_gpiomux_config msm8x60_gsbi_configs[] __initdata = {
	...
	},
	{
		.gpio      = 34,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi_i2c_touch,
		},
	},
	{
		.gpio      = 35,
...
static struct msm_gpiomux_config msm8x60_gsbi_kttech_configs[] __initdata = {
// TSP Config : GSBI 1
	{
		.gpio      = 35,
		.settings = {
			[GPIOMUX_ACTIVE] = &gsbi_i2c_touch,
		},
	},
	{
		.gpio      = 36,
    ...
    // TSP Interrupt
	{
		.gpio      = 66,
		.settings = {
			[GPIOMUX_ACTIVE] = &gsbi_irq_sleep,
		},
	},

// Camera Config  : GSBI 4
   {
		.gpio      = 47,
		.settings = {
...
// Sound Codec : GSBI 7
	{
		.gpio      = 59,
		.settings = {
			[GPIOMUX_ACTIVE] = &gsbi7,
			[GPIOMUX_SUSPENDED] = &default_sleep_pu,
		},
	},
	{
		.gpio      = 60,
...
#endif
#if 0
#ifdef CONFIG_MACH_KTTECH //sleep current(accel sensor int pin)
	{
		.gpio	   = 128,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi_irq_sleep_pd,
...
#ifdef CONFIG_MACH_KTTECH //sleep current(geomag sensor int pin)
	{
		.gpio      = 130,
		.settings = {
			[GPIOMUX_SUSPENDED] = &msm_snddev_suspend_config,
...
#ifdef CONFIG_MACH_KTTECH 
static struct msm_gpiomux_config msm8x60_ebi2_kttech_configs[] __initdata = {
	{
		.gpio      = 92,
		.settings = {
			[GPIOMUX_SUSPENDED] = &ps_hold,
...
#if 0
	{
		.gpio      = 124,
		.settings = {
		[GPIOMUX_SUSPENDED] = &gsbi_irq_sleep,
		},
	},
#endif
};
...
static struct msm_gpiomux_config msm8x60_uart_configs[] __initdata = {
...
#ifdef CONFIG_MACH_KTTECH 
	{
		.gpio      = 118,
		.settings = {
			[GPIOMUX_SUSPENDED] = &console_uart_dn,
		},
	},
#else
	{
...
#ifdef CONFIG_MACH_KTTECH 
	{msm8x60_gsbi_kttech_configs, ARRAY_SIZE(msm8x60_gsbi_kttech_configs)},
#else
	{msm8x60_gsbi_configs, ARRAY_SIZE(msm8x60_gsbi_configs)},
#endif
#ifdef CONFIG_MACH_KTTECH 
	{msm8x60_ebi2_kttech_configs, ARRAY_SIZE(msm8x60_ebi2_kttech_configs)},
#else
