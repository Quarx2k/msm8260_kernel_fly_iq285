...
static void msm_snddev_enable_dmic_power(void)
{
	...
	pr_debug("%s: enable main mic\n", __func__);
#if defined(CONFIG_KTTECH_SND_CODEC_WM8993)
	wm8993_enable(AMP_PATH_MAINMIC);
#elif defined(CONFIG_KTTECH_SOUND_AMP)
...
static void msm_snddev_disable_dmic_power(void)
{
	...
	pr_debug("%s: disable main mic\n", __func__);
#if defined(CONFIG_KTTECH_SND_CODEC_WM8993)
	wm8993_disable(AMP_PATH_MAINMIC);
#elif defined(CONFIG_KTTECH_SOUND_AMP)
...
#if defined(CONFIG_KTTECH_SND_CODEC_WM8993)
	wm8993_enable(AMP_PATH_SPEAKER);
#elif defined(CONFIG_KTTECH_SOUND_AMP)
...
void msm_snddev_poweramp_off(void)
{
	...
	wm8993_disable(AMP_PATH_SPEAKER);
#elif defined(CONFIG_KTTECH_SOUND_AMP)
...
{
	pr_debug("%s: enable stereo headset amp\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_enable(AMP_PATH_HEADSET);
#else
...
{
	pr_debug("%s: disable stereo headset amp\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_disable(AMP_PATH_HEADSET);
#else
...
{
	pr_debug("%s: enable stereo headset and spkr amp\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_enable(AMP_PATH_HEADSET_SPEAKER);
#else
...
{
	pr_debug("%s: disable stereo headset and spkr amp\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_disable(AMP_PATH_HEADSET_SPEAKER);
#else
...
void msm_snddev_hand_poweramp_on(void)
{
	pr_debug("%s: enable mono handset amp\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_enable(AMP_PATH_HANDSET);
#else
...
{
	pr_debug("%s: disable mono handset amp\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_disable(AMP_PATH_HANDSET);
#else
...
void msm_snddev_hs_mic_poweramp_on(void)
{
	pr_debug("%s: enable ear mic\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_enable(AMP_PATH_EARMIC);
#else
...
{
	pr_debug("%s: disable ear mic\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_disable(AMP_PATH_EARMIC);
#else
...
void msm_snddev_hs_with_mic_poweramp_on(void)
{
	pr_debug("%s: enable headset and earmic\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
...
{
	pr_debug("%s: disable headset and earmic\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
...
void msm_snddev_spk_with_mic_poweramp_on(void)
{
#ifdef CONFIG_PMIC8058_OTHC
	int ret;
	...
	pr_debug("%s: enable speaker and mainmic\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_set_caltype(AMP_CAL_VOICECALL);
	wm8993_enable(AMP_PATH_SPEAKER);
#else
...
void msm_snddev_spk_with_mic_poweramp_off(void)
{
	...
	pr_debug("%s: disable speaker and mainmic\n", __func__);
#ifdef CONFIG_KTTECH_SND_CODEC_WM8993
	wm8993_set_caltype(AMP_CAL_NORMAL);
	wm8993_disable(AMP_PATH_SPEAKER);
#else
...
{
	pr_debug("%s: enable main dmic second power\n", __func__);
...
{
	pr_debug("%s: disable main dmic second power\n", __func__);
