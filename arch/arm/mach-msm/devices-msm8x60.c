...
#endif // defined(CONFIG_KTTECH_TOUCH_QT602240) || defined(CONFIG_KTTECH_TOUCH_MCS7000) || defined(CONFIG_KTTECH_TOUCH_QT602240_V3)
...
// KT Tech Total KGSL Vmalloc Size is Less than 4GB.
// (Max count : 16)*(VA Size : 128MB) = 2GB : OK.
	.pt_va_size = SZ_128M,
...
/* Use GSBI10 QUP for /dev/i2c-10  (MAXIM Fuel Gauge) */
...
struct clk_lookup msm_clocks_8x60[] = {
...
#else
	CLK_8X60("gsbi_qup_clk",	GSBI3_QUP_CLK, "spi_qsd.0", OFF),
#endif
...
#ifdef CONFIG_KTTECH_BATTERY_GAUGE_MAXIM
	CLK_8X60("gsbi_qup_clk",	GSBI10_QUP_CLK, "qup_i2c.10", OFF),
#else
...
#else
	CLK_8X60("gsbi_pclk",		GSBI3_P_CLK, 	"spi_qsd.0", OFF),
#endif					
...
#ifdef CONFIG_KTTECH_BATTERY_GAUGE_MAXIM
	CLK_8X60("gsbi_pclk",		GSBI10_P_CLK, "qup_i2c.10", OFF),
#else
	...
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_mt9m113.0",
			OFF),
#else
...
#ifdef CONFIG_KTTECH_MT9M113 // jykim
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_mt9m113.0",
			OFF),
#else
...
#ifdef CONFIG_KTTECH_MT9M113 // jykim
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	  "msm_camera_mt9m113.0",
			OFF),
#else
